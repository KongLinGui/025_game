...
{	
	...
	public class MultipleObjectPooler : ObjectPooler
	{
		...
		public int[] NumberOfObjectsPooled;
		...
		public override GameObject GetPooledGameObject()
		{
			...
			while ( (_pooledGameObjects[randomIndex].activeInHierarchy) && (preventOverflowCounter<_pooledGameObjects.Count) )
			{
			...
			if (_pooledGameObjects[randomIndex].activeInHierarchy)
			{	
				...
				if (PoolCanExpand)
				{
					...
					AddOneObjectToThePool(GameObjectsToPool[randomIndex]);				
					return null;
				}
				else
				{
