...
{	
	...
	public class LevelManager : MonoBehaviour
	{
		...
		protected virtual void Start()
		{
	        ...
	        // level bounds initialization
	        _recycleX = RecycleLine.GetComponent<Renderer>().bounds.max.x;
		...
		{
			if (objectBounds.max.x + destroyDistance < _recycleX) 
			{
				return true;
			} 
			else 
