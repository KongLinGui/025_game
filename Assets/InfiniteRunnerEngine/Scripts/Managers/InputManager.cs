...
{	
	...
	public class InputManager : MonoBehaviour
	{
	    ...
	    public virtual void MainActionButtonDown()
	    {
	        ...
	        for (int i = 0; i < GameManager.Instance.CurrentPlayableCharacters.Count; ++i)
	        {
	            GameManager.Instance.CurrentPlayableCharacters[i].MainActionStart();
	        }
	    }
	    ...
	    {    	
	        for (int i = 0; i < GameManager.Instance.CurrentPlayableCharacters.Count; ++i)
	        {
	            GameManager.Instance.CurrentPlayableCharacters[i].MainActionEnd();
	        }
		}
	    ...
	    public virtual void LeftButtonDown()
	    {
	        ...
	        for (int i = 0; i < GameManager.Instance.CurrentPlayableCharacters.Count; ++i)
	        {
	            GameManager.Instance.CurrentPlayableCharacters[i].LeftStart();
	        }
	    }
	    ...
	    public virtual void LeftButtonUp()
	    {
	        for (int i = 0; i < GameManager.Instance.CurrentPlayableCharacters.Count; ++i)
	        {
	            GameManager.Instance.CurrentPlayableCharacters[i].LeftEnd();
	        }
	    }
	    ...
	    public virtual void LeftButtonPressed()
	    {
	        for (int i = 0; i < GameManager.Instance.CurrentPlayableCharacters.Count; ++i)
	        {
	            GameManager.Instance.CurrentPlayableCharacters[i].LeftOngoing();
	        }
	    }
	    ...
	    public virtual void RightButtonDown()
	    {
	        for (int i = 0; i < GameManager.Instance.CurrentPlayableCharacters.Count; ++i)
	        {
	            GameManager.Instance.CurrentPlayableCharacters[i].RightStart();
	        }
	    }
	    ...
	    public virtual void RightButtonUp()
	    {
	        for (int i = 0; i < GameManager.Instance.CurrentPlayableCharacters.Count; ++i)
	        {
	            GameManager.Instance.CurrentPlayableCharacters[i].RightEnd();
	        }
	    }
	    ...
	    public virtual void RightButtonPressed()
	    {
	        for (int i = 0; i < GameManager.Instance.CurrentPlayableCharacters.Count; ++i)
	        {
	            GameManager.Instance.CurrentPlayableCharacters[i].RightOngoing();
	        }
	    }
	    ...
	    public virtual void DownButtonDown()
	    {
	        for (int i = 0; i < GameManager.Instance.CurrentPlayableCharacters.Count; ++i)
	        {
	            GameManager.Instance.CurrentPlayableCharacters[i].DownStart();
	        }
	    }
	    ...
	    public virtual void DownButtonUp()
	    {
	        for (int i = 0; i < GameManager.Instance.CurrentPlayableCharacters.Count; ++i)
	        {
	            GameManager.Instance.CurrentPlayableCharacters[i].DownEnd();
	        }
	    }
	    ...
	    public virtual void DownButtonPressed()
	    {
	        for (int i = 0; i < GameManager.Instance.CurrentPlayableCharacters.Count; ++i)
	        {
	            GameManager.Instance.CurrentPlayableCharacters[i].DownOngoing();
	        }
	    }
	    ...
	    public virtual void UpButtonDown()
	    {
	        for (int i = 0; i < GameManager.Instance.CurrentPlayableCharacters.Count; ++i)
	        {
	            GameManager.Instance.CurrentPlayableCharacters[i].UpStart();
	        }
	    }
	    ...
	    public virtual void UpButtonUp()
	    {
	        for (int i = 0; i < GameManager.Instance.CurrentPlayableCharacters.Count; ++i)
	        {
	            GameManager.Instance.CurrentPlayableCharacters[i].UpEnd();
	        }
	    }
	    ...
	    public virtual void UpButtonPressed()
	    {
	        for (int i = 0; i < GameManager.Instance.CurrentPlayableCharacters.Count; ++i)
	        {
	            GameManager.Instance.CurrentPlayableCharacters[i].UpOngoing();
	        }
	    }
	}
}